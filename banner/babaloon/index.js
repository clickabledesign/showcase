...
(lib.Символ41 = function(mode,startPosition,loop) {
	...
	this.shape.graphics.f("#FFFFFF").s().p("AhgD1IAAnpIA2AAIAAG4ICLAAIAAAxg");
	this.shape.setTransform(253.8,33);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("#FFFFFF").s().p("AhgD1IAAnpIA2AAIAAG4ICLAAIAAAxg");
	this.shape_1.setTransform(230.3,33);

	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.f("#FFFFFF").s().p("ABPD1IgThjIh7AAIgTBjIgyAAIBdnpIBPAAIBdHpgAA0BjIg2kZIg2EZIBsAAg");
	this.shape_2.setTransform(203,33);

	this.shape_3 = new cjs.Shape();
	this.shape_3.graphics.f("#FFFFFF").s().p("");
	this.shape_3.setTransform(174.9,33);

	this.shape_4 = new cjs.Shape();
	this.shape_4.graphics.f("#FFFFFF").s().p("AhkD1IAAnpIDJAAIAAAyIiSAAIAACnIB3AAIAAAwIh3AAIAACvICSAAIAAAxg");
	this.shape_4.setTransform(137.7,33);

	this.shape_5 = new cjs.Shape();
	this.shape_5.graphics.f("#FFFFFF").s().p("AA8D1IAAjcIh3AAIAADcIg3AAIAAnpIA3AAIAADcIB3AAIAAjcIA3AAIAAHpg");
	this.shape_5.setTransform(110.5,33);

	this.shape_6 = new cjs.Shape();
	this.shape_6.graphics.f("#FFFFFF").s().p("AgaD1IAAm3IhbAAIAAgyIDrAAIAAAyIhbAAIAAG3g");
	this.shape_6.setTransform(83.5,33);

	this.shape_7 = new cjs.Shape();
	this.shape_7.graphics.f("#FFFFFF").s().p("AgaD1IAAm3IhbAAIAAgyIDrAAIAAAyIhbAAIAAG3g");
	this.shape_7.setTransform(47.3,33);

	this.shape_8 = new cjs.Shape();
	this.shape_8.graphics.f("#FFFFFF").s().p("AgaD1IAAnpIA1AAIAAHpg");
	this.shape_8.setTransform(29.1,33);

	this.shape_9 = new cjs.Shape();
	this.shape_9.graphics.f("#FFFFFF").s().p("AA8D1IAAjcIh3AAIAADcIg3AAIAAnpIA3AAIAADcIB3AAIAAjcIA3AAIAAHpg");
	this.shape_9.setTransform(9.3,33);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.shape_9},{t:this.shape_8},{t:this.shape_7},{t:this.shape_6},{t:this.shape_5},{t:this.shape_4},{t:this.shape_3},{t:this.shape_2},{t:this.shape_1},{t:this.shape}]}).wait(1));

	// Слой 3
	this.shape_10 = new cjs.Shape();
	this.shape_10.graphics.f("rgba(0,0,0,0.498)").s().p("AhgD1IAAnpIA2AAIAAG3ICLAAIAAAyg");
	this.shape_10.setTransform(255.8,35);

	this.shape_11 = new cjs.Shape();
	this.shape_11.graphics.f("rgba(0,0,0,0.498)").s().p("AhgD1IAAnpIA2AAIAAG3ICLAAIAAAyg");
	this.shape_11.setTransform(232.3,35);

	this.shape_12 = new cjs.Shape();
	this.shape_12.graphics.f("rgba(0,0,0,0.498)").s().p("ABPD1IgThjIh7AAIgTBjIgyAAIBdnpIBPAAIBdHpgAA0BjIg2kaIg2EaIBsAAg");
	this.shape_12.setTransform(205,35);

	this.shape_13 = new cjs.Shape();
	this.shape_13.graphics.f("rgba(0,0,0,0.498)").s().p("");
	this.shape_13.setTransform(176.9,35);

	this.shape_14 = new cjs.Shape();
	this.shape_14.graphics.f("rgba(0,0,0,0.498)").s().p("AhkD1IAAnpIDJAAIAAAyIiSAAIAACnIB3AAIAAAwIh3AAIAACuICSAAIAAAyg");
	this.shape_14.setTransform(139.7,35);

	this.shape_15 = new cjs.Shape();
	this.shape_15.graphics.f("rgba(0,0,0,0.498)").s().p("AA8D1IAAjdIh3AAIAADdIg3AAIAAnpIA3AAIAADdIB3AAIAAjdIA3AAIAAHpg");
	this.shape_15.setTransform(112.5,35);

	this.shape_16 = new cjs.Shape();
	this.shape_16.graphics.f("rgba(0,0,0,0.498)").s().p("AgaD1IAAm3IhbAAIAAgyIDrAAIAAAyIhbAAIAAG3g");
	this.shape_16.setTransform(85.5,35);

	this.shape_17 = new cjs.Shape();
	this.shape_17.graphics.f("rgba(0,0,0,0.498)").s().p("AgaD1IAAm3IhbAAIAAgyIDrAAIAAAyIhbAAIAAG3g");
	this.shape_17.setTransform(49.3,35);

	this.shape_18 = new cjs.Shape();
	this.shape_18.graphics.f("rgba(0,0,0,0.498)").s().p("AgaD1IAAnpIA1AAIAAHpg");
	this.shape_18.setTransform(31.1,35);

	this.shape_19 = new cjs.Shape();
	this.shape_19.graphics.f("rgba(0,0,0,0.498)").s().p("AA8D1IAAjdIh3AAIAADdIg3AAIAAnpIA3AAIAADdIB3AAIAAjdIA3AAIAAHpg");
	this.shape_19.setTransform(11.3,35);
...
}).prototype = getMCSymbolPrototype(lib.Символ41, new cjs.Rectangle(-7,3,276.1,76), null);
...
(lib.Символ40 = function(mode,startPosition,loop) {
	...
	// Слой 3
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#FFFFFF").s().p("AhgD1IAAnpIA2AAIAAG3ICLAAIAAAyg");
	this.shape.setTransform(304.3,31.7);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("#FFFFFF").s().p("AhgD1IAAnpIA2AAIAAG3ICLAAIAAAyg");
	this.shape_1.setTransform(280.7,31.7);

	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.f("#FFFFFF").s().p("ABPD1IgThjIh7AAIgTBjIgyAAIBdnpIBPAAIBdHpgAA0BkIg2kbIg2EbIBsAAg");
	this.shape_2.setTransform(253.4,31.7);

	this.shape_3 = new cjs.Shape();
	this.shape_3.graphics.f("#FFFFFF").s().p("AhgD1IAAnpIDBAAIAAAyIiLAAIAACyIBwAAIAAAwIhwAAIAADVg");
	this.shape_3.setTransform(227.4,31.7);

	this.shape_4 = new cjs.Shape();
	this.shape_4.graphics.f("#FFFFFF").s().p("");
	this.shape_4.setTransform(190.8,31.7);

	this.shape_5 = new cjs.Shape();
	this.shape_5.graphics.f("#FFFFFF").s().p("AhkD1IAAnpIDJAAIAAAyIiSAAIAACnIB3AAIAAAwIh3AAIAACuICSAAIAAAyg");
	this.shape_5.setTransform(164.2,31.7);

	this.shape_6 = new cjs.Shape();
	this.shape_6.graphics.f("#FFFFFF").s().p("AA8D1IAAjdIh3AAIAADdIg3AAIAAnpIA3AAIAADcIB3AAIAAjcIA3AAIAAHpg");
	this.shape_6.setTransform(137,31.7);

	this.shape_7 = new cjs.Shape();
	this.shape_7.graphics.f("#FFFFFF").s().p("AhkD1IAAnpIDJAAIAAAyIiSAAIAACnIB3AAIAAAwIh3AAIAACuICSAAIAAAyg");
	this.shape_7.setTransform(99.6,31.7);

	this.shape_8 = new cjs.Shape();
	this.shape_8.graphics.f("#FFFFFF").s().p("ABCD1IhojVIgdAxIAACkIg2AAIAAnpIA2AAIAADtICCjtIA3AAIh7DfIB/EKg");
	this.shape_8.setTransform(73.1,31.7);

	this.shape_9 = new cjs.Shape();
	this.shape_9.graphics.f("#FFFFFF").s().p("ABPD1IgThjIh7AAIgTBjIgyAAIBdnpIBPAAIBdHpgAA0BkIg2kbIg2EbIBsAAg");
	this.shape_9.setTransform(43.3,31.7);

	this.shape_10 = new cjs.Shape();
	this.shape_10.graphics.f("#FFFFFF").s().p("ABoD1IAAmJIhOGJIg0AAIhRmFIAAGFIgvAAIAAnpIBMAAIBPGGIBOmGIBMAAIAAHpg");
	this.shape_10.setTransform(10.3,31.7);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.shape_10},{t:this.shape_9},{t:this.shape_8},{t:this.shape_7},{t:this.shape_6},{t:this.shape_5},{t:this.shape_4},{t:this.shape_3},{t:this.shape_2},{t:this.shape_1},{t:this.shape}]}).wait(1));

	// Слой 2
	this.shape_11 = new cjs.Shape();
	this.shape_11.graphics.f("rgba(0,0,0,0.498)").s().p("AhgD1IAAnpIA2AAIAAG4ICLAAIAAAxg");
	this.shape_11.setTransform(306.3,33.7);

	this.shape_12 = new cjs.Shape();
	this.shape_12.graphics.f("rgba(0,0,0,0.498)").s().p("AhgD1IAAnpIA2AAIAAG4ICLAAIAAAxg");
	this.shape_12.setTransform(282.7,33.7);

	this.shape_13 = new cjs.Shape();
	this.shape_13.graphics.f("rgba(0,0,0,0.498)").s().p("ABPD1IgThjIh7AAIgTBjIgyAAIBdnpIBPAAIBdHpgAA0BjIg2kZIg2EZIBsAAg");
	this.shape_13.setTransform(255.4,33.7);

	this.shape_14 = new cjs.Shape();
	this.shape_14.graphics.f("rgba(0,0,0,0.498)").s().p("AhgD1IAAnpIDBAAIAAAyIiLAAIAACyIBwAAIAAAxIhwAAIAADUg");
	this.shape_14.setTransform(229.4,33.7);

	this.shape_15 = new cjs.Shape();
	this.shape_15.graphics.f("rgba(0,0,0,0.498)").s().p("");
	this.shape_15.setTransform(192.8,33.7);

	this.shape_16 = new cjs.Shape();
	this.shape_16.graphics.f("rgba(0,0,0,0.498)").s().p("AhkD1IAAnpIDJAAIAAAyIiSAAIAACnIB3AAIAAAwIh3AAIAACvICSAAIAAAxg");
	this.shape_16.setTransform(166.2,33.7);

	this.shape_17 = new cjs.Shape();
	this.shape_17.graphics.f("rgba(0,0,0,0.498)").s().p("AA8D1IAAjcIh3AAIAADcIg3AAIAAnpIA3AAIAADcIB3AAIAAjcIA3AAIAAHpg");
	this.shape_17.setTransform(139,33.7);

	this.shape_18 = new cjs.Shape();
	this.shape_18.graphics.f("rgba(0,0,0,0.498)").s().p("AhkD1IAAnpIDJAAIAAAyIiSAAIAACnIB3AAIAAAwIh3AAIAACvICSAAIAAAxg");
	this.shape_18.setTransform(101.6,33.7);

	this.shape_19 = new cjs.Shape();
	this.shape_19.graphics.f("rgba(0,0,0,0.498)").s().p("ABCD1IhojVIgdAxIAACkIg2AAIAAnpIA2AAIAADsICCjsIA3AAIh7DgIB/EJg");
	this.shape_19.setTransform(75.1,33.7);

	this.shape_20 = new cjs.Shape();
	this.shape_20.graphics.f("rgba(0,0,0,0.498)").s().p("ABPD1IgThjIh7AAIgTBjIgyAAIBdnpIBPAAIBdHpgAA0BjIg2kZIg2EZIBsAAg");
	this.shape_20.setTransform(45.3,33.7);

	this.shape_21 = new cjs.Shape();
	this.shape_21.graphics.f("rgba(0,0,0,0.498)").s().p("ABoD1IAAmJIhOGIIg0AAIhRmEIAAGFIgvAAIAAnpIBMAAIBPGGIBOmGIBMAAIAAHpg");
	this.shape_21.setTransform(12.3,33.7);
...
}).prototype = getMCSymbolPrototype(lib.Символ40, new cjs.Rectangle(-10,1.7,329.5,76), null);
...
p.nominalBounds = new cjs.Rectangle(157.6,-79.6,276,76);
...
(lib.Символ30 = function(mode,startPosition,loop) {
	...
	this.shape = new cjs.Shape();
	this.shape.graphics.f().s("#F99E00").ss(3,1,1).p("AEgAAIA6AAQAACPhmBlQhlBmiPAAQiPAAhlhmQhlhlAAiPQAAiPBlhlQBlhlCPAAQCPAABlBlQBmBlAACPIBfAAAAAm9IAABkIAAArAm4AAIBfAAIA7AAAAAFJIAAARIAABk");
...
// stage content:
(lib.babaloon_640x305 = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});
	...
	this.tek.setTransform(271.9,30.6,1,1,0,0,0,220.3,25);
	...
	this.fon.setTransform(-19.8,-22,0.887,0.887,0,0,0,50.9,60.8);

	this.timeline.addTween(cjs.Tween.get(this.fon).wait(1));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(55.9,76.6,950.3,729.7);
// library properties:
lib.properties = {
	width: 640,
	height: 305,
	...
	opacity: 1.00,
	manifest: [
		{src:"images/back.jpg?1493292361978", id:"back"},
		{src:"images/hand.png?1493292361978", id:"hand"},
		{src:"images/item1.png?1493292361978", id:"item1"},
		{src:"images/item10.png?1493292361978", id:"item10"},
		{src:"images/item11.png?1493292361978", id:"item11"},
		{src:"images/item12.png?1493292361978", id:"item12"},
		{src:"images/item13.png?1493292361978", id:"item13"},
		{src:"images/item14.png?1493292361978", id:"item14"},
		{src:"images/item2.png?1493292361978", id:"item2"},
		{src:"images/item3.png?1493292361978", id:"item3"},
		{src:"images/item4.png?1493292361978", id:"item4"},
		{src:"images/item5.png?1493292361978", id:"item5"},
		{src:"images/item6.png?1493292361978", id:"item6"},
		{src:"images/item7.png?1493292361978", id:"item7"},
		{src:"images/item8.png?1493292361978", id:"item8"},
		{src:"images/item9.png?1493292361978", id:"item9"},
		{src:"images/suri.png?1493292361978", id:"suri"}
	],
	preloads: []
};
