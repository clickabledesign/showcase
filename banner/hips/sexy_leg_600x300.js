...
(lib.Символ29 = function() {
	...
	// Слой 1
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#00FF00").s().p("ACDAsQgMgFgmgKQgkgKgTgIQglgRhYgWQhNgUgQAAQgFAAgDgEIgBgEQABgFAEgEQAEgDAHAAIAfAGIAhgIQAjgJASgDQAMgCAaABQApACAaAAIBRgGQAuAAAMAFQAXAJAAAkQAAAHgEABQgKAEgJAJQAEAOAMAPIAKAOQgBAHgTA2QgkglgPgHg");
	this.shape.setTransform(20.2,8.9);

	this.addChild(this.shape);
}).prototype = p = new cjs.Container();
p.nominalBounds = new cjs.Rectangle(0,0,40.4,17.7);
...
(lib.Символ30_1 = function(mode,startPosition,loop) {
	...
	this.instance.setTransform(20.2,8.8,1,1,0,0,0,20.2,8.8);
	this.instance.alpha = 0.68;
	this.instance._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1).to({_off:false},0).wait(1).to({alpha:1},0).wait(2));
...
(lib.Символ17 = function(mode,startPosition,loop) {
	...
	this.timeline.addTween(cjs.Tween.get(this.instance).to({alpha:0.227},7,cjs.Ease.get(-1)).to({alpha:0},7,cjs.Ease.get(1)).to({alpha:0.234},7,cjs.Ease.get(-1)).to({alpha:0.469},8,cjs.Ease.get(1)).wait(1));
...
(lib.Символ9 = function() {
	...
	this.instance.setTransform(119.6,51,1,1,0,0,0,20.2,8.8);
...
(lib.Символ3 = function(mode,startPosition,loop) {
	...
	this.instance_5.setTransform(289,133,1,1,0,0,0,21,23);

	this.timeline.addTween(cjs.Tween.get(this.instance_5).to({regY:23.1,scaleY:1.04,y:134.6},14,cjs.Ease.get(-1)).to({regY:23,scaleY:1.09,y:136.2},15,cjs.Ease.get(1)).to({scaleY:1.04,y:134.6},15,cjs.Ease.get(-1)).to({scaleY:1,y:133},15,cjs.Ease.get(1)).wait(1));

	// Слой 2
	this.instance_6 = new lib.Символ9();
	this.instance_6.setTransform(288.5,215,1,1,0,0,0,128.5,105);

	this.timeline.addTween(cjs.Tween.get(this.instance_6).to({skewY:0.8,y:217.2},14,cjs.Ease.get(-1)).to({scaleX:1,skewY:2,y:219.6},15,cjs.Ease.get(1)).to({regX:128.6,scaleX:1,skewY:1,x:288.6,y:217.3},15,cjs.Ease.get(-1)).to({regX:128.5,skewY:0,x:288.5,y:215},15,cjs.Ease.get(1)).wait(1));
...
(lib.sexy_leg_600x300 = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});
	...
	this.qwe.setTransform(320,152.2,0.866,0.866,0,0,0,369.5,185.1);

	this.timeline.addTween(cjs.Tween.get(this.qwe).wait(1));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(250.2,141.9,963.9,326.1);
