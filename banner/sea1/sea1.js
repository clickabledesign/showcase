...
(lib.Символ85 = function(mode,startPosition,loop) {
	...
	// Слой 1
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#FF0000").s().p("");
	this.shape.setTransform(83.5,0.2);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("#FF0000").s().p("");
	this.shape_1.setTransform(72,0.2);

	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.f("#FF0000").s().p("AgrBtIAAjYIBXAAIAAAVIhAAAIAABKIA0AAIAAAWIg0AAIAABMIBAAAIAAAXg");
	this.shape_2.setTransform(60.8,0.2);

	this.shape_3 = new cjs.Shape();
	this.shape_3.graphics.f("#FF0000").s().p("");
	this.shape_3.setTransform(49.2,0.2);

	this.shape_4 = new cjs.Shape();
	this.shape_4.graphics.f("#FF0000").s().p("AgxBtIAAjYIAyAAQAMgBAJAEQAKAEAGAHQAGAHADAKQADAKAAANIAABsQAAANgDAJQgDAKgGAHQgGAHgKADQgJAFgMAAgAgZBWIAZAAQANAAAHgIQAGgHAAgPIAAhuQAAgQgHgIQgGgIgNAAIgZAAg");
	this.shape_4.setTransform(36.9,0.2);

	this.shape_5 = new cjs.Shape();
	this.shape_5.graphics.f("#FF0000").s().p("AAaBtIg2ivIAACvIgWAAIAAjYIAfAAIAxCbIAAibIAVAAIAADYg");
	this.shape_5.setTransform(24.3,0.2);

	this.shape_6 = new cjs.Shape();
	this.shape_6.graphics.f("#FF0000").s().p("AgVBqQgIgEgHgHQgFgHgDgLQgDgKgBgMIAAikIAYAAIAAClQAAAPAHAIQAGAIAMAAQAMAAAHgIQAGgIAAgPIAAilIAWAAIAACkQAAAMgCAKQgEALgFAHQgHAHgJAEQgJAEgMAAQgMAAgJgEg");
	this.shape_6.setTransform(12,0.3);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.shape_6},{t:this.shape_5},{t:this.shape_4},{t:this.shape_3},{t:this.shape_2},{t:this.shape_1},{t:this.shape}]}).wait(1));

}).prototype = getMCSymbolPrototype(lib.Символ85, new cjs.Rectangle(4,-14.2,87.4,35), null);
...
(lib.Символ75 = function(mode,startPosition,loop) {
	...
	// Слой 1
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#FFFFFF").s().p("AgLBtIAAhPIguiJIAZAAIAhBqIAihqIAXAAIguCJIAABPg");
	this.shape.setTransform(149.7,8);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("#FFFFFF").s().p("AgVBrQgJgEgGgHQgGgIgEgJQgDgLAAgMIAAhvQAAgMADgLQAEgKAGgHQAGgHAJgEQAKgDALAAQAMAAAKADQAJAEAGAHQAHAHADAKQADALAAAMIAABvQAAAMgDALQgDAJgHAIQgGAHgJAEQgKADgMAAQgLAAgKgDgAgThPQgGAIAAAOIAAByQAAAPAGAJQAHAHAMABQANgBAGgHQAHgJAAgPIAAhyQAAgPgHgHQgGgJgNAAQgMAAgHAJg");
	this.shape_1.setTransform(137.3,8);

	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.f("#FFFFFF").s().p("AgUBqQgKgEgGgHQgGgHgDgLQgCgKAAgMIAAikIAYAAIAAClQAAAPAFAIQAHAIALAAQAOAAAGgIQAGgIAAgPIAAilIAXAAIAACkQAAAMgEAKQgCALgHAHQgGAHgIAEQgKAEgMAAQgLAAgJgEg");
	this.shape_2.setTransform(125.4,8.1);

	this.shape_3 = new cjs.Shape();
	this.shape_3.graphics.f("#FFFFFF").s().p("");
	this.shape_3.setTransform(113.4,8);

	this.shape_4 = new cjs.Shape();
	this.shape_4.graphics.f("#FFFFFF").s().p("AgsBtIAAjYIBYAAIAAAVIg/AAIAABKIA0AAIAAAWIg0AAIAABMIA/AAIAAAXg");
	this.shape_4.setTransform(101.8,8);

	this.shape_5 = new cjs.Shape();
	this.shape_5.graphics.f("#FFFFFF").s().p("AgqBtIAAjYIBVAAIAAAVIg9AAIAABPIAxAAIAAAVIgxAAIAABfg");
	this.shape_5.setTransform(91.1,8);

	this.shape_6 = new cjs.Shape();
	this.shape_6.graphics.f("#FFFFFF").s().p("AgLBtIAAjYIAXAAIAADYg");
	this.shape_6.setTransform(83.2,8);

	this.shape_7 = new cjs.Shape();
	this.shape_7.graphics.f("#FFFFFF").s().p("AgqBtIAAjYIAYAAIAADBIA9AAIAAAXg");
	this.shape_7.setTransform(75.9,8);

	this.shape_8 = new cjs.Shape();
	this.shape_8.graphics.f("#FFFFFF").s().p("AgrBtIAAjYIBYAAIAAAVIhBAAIAABKIA0AAIAAAWIg0AAIAABMIBBAAIAAAXg");
	this.shape_8.setTransform(60.1,8);

	this.shape_9 = new cjs.Shape();
	this.shape_9.graphics.f("#FFFFFF").s().p("AAbBtIAAhiIg1AAIAABiIgYAAIAAjYIAYAAIAABhIA1AAIAAhhIAYAAIAADYg");
	this.shape_9.setTransform(48.1,8);

	this.shape_10 = new cjs.Shape();
	this.shape_10.graphics.f("#FFFFFF").s().p("AgLBtIAAjDIgoAAIAAgVIBnAAIAAAVIgoAAIAADDg");
	this.shape_10.setTransform(36.1,8);

	this.shape_11 = new cjs.Shape();
	this.shape_11.graphics.f("#FFFFFF").s().p("AgLBtIAAjDIgoAAIAAgVIBnAAIAAAVIgnAAIAADDg");
	this.shape_11.setTransform(20.1,8);

	this.shape_12 = new cjs.Shape();
	this.shape_12.graphics.f("#FFFFFF").s().p("AgLBtIAAjYIAXAAIAADYg");
	this.shape_12.setTransform(12.1,8);

	this.shape_13 = new cjs.Shape();
	this.shape_13.graphics.f("#FFFFFF").s().p("AAbBtIAAhiIg1AAIAABiIgYAAIAAjYIAYAAIAABhIA1AAIAAhhIAYAAIAADYg");
	this.shape_13.setTransform(3.3,8);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.shape_13},{t:this.shape_12},{t:this.shape_11},{t:this.shape_10},{t:this.shape_9},{t:this.shape_8},{t:this.shape_7},{t:this.shape_6},{t:this.shape_5},{t:this.shape_4},{t:this.shape_3},{t:this.shape_2},{t:this.shape_1},{t:this.shape}]}).wait(1));

}).prototype = getMCSymbolPrototype(lib.Символ75, new cjs.Rectangle(-5,-6.4,163.1,35), null);
...
p.nominalBounds = new cjs.Rectangle(4,-14.2,87.4,35);
...
}).prototype = getMCSymbolPrototype(lib.Символ80, new cjs.Rectangle(0,-29.8,97.5,91.9), null);
...
}).prototype = getMCSymbolPrototype(lib.Символ11, new cjs.Rectangle(0,-29.8,97.5,91.9), null);
...
(lib.Символ16 = function(mode,startPosition,loop) {
	...
	this.instance.parent = this;
	this.instance.setTransform(47,82,1,1,0,0,0,0,31);

	this.timeline.addTween(cjs.Tween.get(this.instance).to({scaleX:1.14,scaleY:1.14,x:40,y:83.5},29,cjs.Ease.get(1)).to({scaleX:1,scaleY:1,x:47,y:82},30,cjs.Ease.get(1)).wait(1));
...
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/aio.png?1493297136579", id:"aio"},
		{src:"images/chayka.png?1493297136579", id:"chayka"},
		{src:"images/chayka_big.png?1493297136579", id:"chayka_big"},
		{src:"images/garp_icon.png?1493297136579", id:"garp_icon"},
		{src:"images/girl_03.png?1493297136579", id:"girl_03"},
		{src:"images/girl_06.png?1493297136579", id:"girl_06"},
		{src:"images/girl_09.png?1493297136579", id:"girl_09"},
		{src:"images/girl_12.png?1493297136579", id:"girl_12"},
		{src:"images/girl_15.png?1493297136579", id:"girl_15"},
		{src:"images/girl_17.png?1493297136579", id:"girl_17"},
		{src:"images/girl_20.png?1493297136579", id:"girl_20"},
		{src:"images/girl_29.png?1493297136579", id:"girl_29"},
		{src:"images/guli_icon.png?1493297136579", id:"guli_icon"},
		{src:"images/mouse.png?1493297136579", id:"mouse"},
		{src:"images/sea.jpg?1493297136579", id:"sea"},
		{src:"images/sky.jpg?1493297136579", id:"sky"},
		{src:"images/trizub.png?1493297136579", id:"trizub"}
	],
	preloads: []
};
